 ...
 * 
 * A card component for displaying information with an icon header.
 * 
 * Usage:
 * <InfoCard
 *   icon={Cpu}
...
const InfoCard = ({
  ...
  return (
    <div
      className={cn(
        "bg-sparkle-card backdrop-blur-sm rounded-xl border border-sparkle-border hover:shadow-sm overflow-hidden p-5 transition-shadow",
        className
      )}
      {...props}
    >
