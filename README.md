...
Current documentation snapshot: May 17, 2026. The app remains on the `1.6.6-beta.1` release/update line, with no desktop app commits after the May 16 docs refresh (`e49ed54`) on `dev`.
