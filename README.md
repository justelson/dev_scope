...
Current documentation snapshot: May 15, 2026. The app remains on the `1.6.6-beta.1` release/update line, with no desktop app commits after the May 14 docs refresh (`e9c00d7`) on `dev`.
