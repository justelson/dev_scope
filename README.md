...
Current documentation snapshot: May 13, 2026. The app remains on the `1.6.6-beta.1` release/update line, with no desktop app commits after the May 12 docs refresh (`f694718`) on `dev`.
