...
Current documentation snapshot: May 14, 2026. The app remains on the `1.6.6-beta.1` release/update line, with no desktop app commits after the May 13 docs refresh (`918b6ef`) on `dev`.
