...
Current documentation snapshot: May 12, 2026. The app remains on the `1.6.6-beta.1` release/update line, with no desktop app commits after the May 11 docs refresh (`bc3d0a3`) on `dev`.
