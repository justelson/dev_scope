...
Current documentation snapshot: May 18, 2026. The app remains on the `1.6.6-beta.1` release/update line, with no desktop app commits after the May 17 docs refresh (`6cce2aa`) on `dev`.
