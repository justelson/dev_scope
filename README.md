...
Current documentation snapshot: May 10, 2026. The app remains on the `1.6.6-beta.1` release/update line, with no desktop app commits after the May 9 docs refresh (`bd60200`) on `dev`.
