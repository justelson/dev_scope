...
Current documentation snapshot: May 16, 2026. The app remains on the `1.6.6-beta.1` release/update line, with no desktop app commits after the May 15 docs refresh (`34c2f28`) on `dev`.
