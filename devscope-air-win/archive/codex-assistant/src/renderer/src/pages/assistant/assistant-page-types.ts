...
export type AssistantUserInputOption = {
    label: string
    description: string
}

export type AssistantUserInputQuestion = {
    id: string
    header: string
    question: string
...
export type AssistantPendingUserInput = {
    requestId: number
...
export type AssistantSendMetadata = {
    entryMode?: 'chat' | 'plan'
...
export function parseUserInputQuestions(value: unknown): AssistantUserInputQuestion[] {
            ...
            const options = Array.isArray(question.options)
                ? question.options
                    .map((option) => {
                        ...
                        return { label, description } as AssistantUserInputOption
                    })
                    .filter((option): option is AssistantUserInputOption => Boolean(option))
                : []
