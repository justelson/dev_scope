...
Last validated against code on April 26, 2026.
...
- Package runtime detection is main-process owned through IPC, while renderer settings choose either auto lockfile detection or an installed explicit runtime for project script buttons.
