...
## May 9 Current-State Verification

- Current package line is `1.6.6-beta.1`.
- No desktop app commits landed on `dev` after the May 6 docs refresh commit `cd7353f`.
