...
## May 17 Current-State Verification

- Current package line is `1.6.6-beta.1`.
- No desktop app commits landed on `dev` after the May 16 docs refresh commit `e49ed54`.
