...
- GitHub Actions should publish the release body generated by `scripts/maint/generate-release-notes.mjs`; do not rely on GitHub autogenerated notes for the canonical release changelog.
...
- Current-state note: no desktop app commits landed on `dev` after the May 16 docs refresh commit `e49ed54`; the package line remains `1.6.6-beta.1`.
